 ...
 *
 * @param {Function} f
 * @param {Function} lf - function to output log with single string argument
 * @return {Function}
 *
 * @example
 *
 ...
 *
 */
function logger(f, lf, n = f.name) {
  return (...args) => {
    const l = `${n}(${JSON.stringify(args).slice(1, -1)})`;
 ...
 *   partialUsingArguments(fn, 'a','b','c','d')() => 'abcd'
 */
function partialUsingArguments(f, ...args1) {
